...
pub enum ParseTreeNode
{
    ...
    UnaryExpression{operation: UnaryExpressionOperation, children: Vec<ParseTreeNode>, optoken: Token},
...
impl ParseTreeNode
{
    ...
    pub fn get_children(&self) -> Option<Vec<ParseTreeNode>>
    {
        match self
        {
            ...
            ParseTreeNode::UnaryExpression { children, .. } => Some(children.to_vec()),
